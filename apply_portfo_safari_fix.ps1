            ...
            <ul>
                <li class="menu-item">
                    <a href="index.html"
                        ...
                        hx-get="content/partials/home.html" hx-target="#mainContent" hx-swap="innerHTML">
                ...
                <li class="menu-item">
                    ...
                    <ul class="submenu pl-6 bg-green-50" aria-hidden="true">
                        <li><a href="content/service1.html"
                                ...
                                hx-get="content/partials/service1.html" hx-target="#mainContent"
                                hx-swap="innerHTML">Demos</a></li>
                        <li><a href="#"
                                class="block px-4 py-1 hover:bg-green-200 transition-colors duration-200 focus:outline-none focus:bg-green-300 sidebar-content">Soon...</a>
                        </li>
                        <li><a href="#"
                                class="block px-4 py-1 hover:bg-green-200 transition-colors duration-200 focus:outline-none focus:bg-green-300 sidebar-content">Soon...</a>
                        </li>
